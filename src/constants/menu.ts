import { getUserFromLocalStorage } from "./userLocal";
...
const MENU_ITEMS: MenuItemTypes[] = [
  { key: "mywall", label: "My Wall", isTitle: true },
  {
    key: "dashboard",
    label: "My Profile",
    isTitle: false,
  ...
  { key: "information", label: "Information", isTitle: true },
  {
...
if (getUserFromLocalStorage()?.roles[0] == "LECTURE") {
  MENU_ITEMS.push(
